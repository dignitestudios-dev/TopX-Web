    ...
    <button className="text-[13px] font-[400] text-[#DE4B12]">{headerbutton}</button>
        ...
        <div className={baseClasses} >
            ...
            <div className="flex items-center gap-2  ">
                <img src={topics} alt={topics} className="w-[40px] h-[40px] rounded-full" />
          ...
          <div className="w-full flex items-center justify-between ">
            <div className="w-full flex items-center gap-[70px] relative">
                <div className=" flex items-center  ">
                    <img src="https://randomuser.me/api/portraits/women/1.jpg" alt="https://randomuser.me/api/portraits/women/1.jpg" className="w-[24px] h-[24px] rounded-full absolute top-0 left-0" />
                    <img src="https://randomuser.me/api/portraits/women/2.jpg" alt="https://randomuser.me/api/portraits/women/1.jpg" className="w-[24px] h-[24px] rounded-full absolute top-0 left-5" />
                    <img src="https://randomuser.me/api/portraits/women/3.jpg" alt="https://randomuser.me/api/portraits/women/1.jpg" className="w-[24px] h-[24px] rounded-full absolute top-0 left-10" />
                </div>
            ...
            <Button className="w-full  py-[6px] font-[600] text-[14px] flex items-center justify-center "  variant="orange" >
