    ...
    return (
        <div className="bg-white rounded-2xl mb-4 overflow-hidden shadow-sm border border-gray-100">
            ...
            <div className="p-4 flex items-center justify-between border-b border-gray-100">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">{post.username} · {post.time}</p>
                    </div>
                </div>
                <button
            ...
            <div className="px-4 py-3 border-t border-gray-100 flex items-center gap-6">
                ...
                >
                    <Heart
                        className={`w-5 h-5 transition ${postislike ? 'fill-orange-500 text-orange-500' : 'text-gray-600'
                            }`}
                    />
                    <span className={`text-sm font-medium ${postislike ? 'text-orange-500' : 'text-gray-600'}`}>
                        {post.stats.likes}
                    </span>
                </button>
