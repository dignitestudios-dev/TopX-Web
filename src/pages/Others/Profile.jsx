                ...
                <div className="flex flex-col gap-3">
                  <div className="flex gap-2 border-b border-gray-200">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-3 font-medium transition-all relative ${activeTab === "topics" ? "text-orange-600" : "text-gray-500 hover:text-gray-700"
                        }`}
                    >
                      <div
                        className={`p-1.5 rounded ${activeTab === "topics" ? "bg-orange-600" : "bg-gray-400"
                          }`}
                      >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-3 font-medium transition-all relative ${activeTab === "knowledge"
                        ? "text-orange-600"
                        : "text-gray-500 hover:text-gray-700"
                        }`}
                    >
                      <div
                        className={`p-1.5 rounded ${activeTab === "knowledge" ? "bg-orange-600" : "bg-gray-400"
                          }`}
                      >
